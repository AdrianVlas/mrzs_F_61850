...
extern unsigned int convert_order_list_bi_to_gmm(unsigned int, unsigned int, unsigned int, __getting_data);
...
extern unsigned int save_new_rang_bi_from_gmm(unsigned int, unsigned int, unsigned int, unsigned short int, __settings_data);
