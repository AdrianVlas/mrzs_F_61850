...
#define FIRST_INDEX_NUMBER_BEFORE_ITEMS_DR    (49 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_ITEMS_DR           (50 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_CHANGES_DR         (51 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_PHASE_DR       (53 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_PHASE04_DR     (54 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_3I0_DR         (55 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_3U0_DR         (56 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MIN_U_DR           (57 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_U_DR           (58 + NUMBER_BYTES_SAMPLE_DR)
#define FIRST_INDEX_NUMBER_MAX_ZOP_DR         (59 + NUMBER_BYTES_SAMPLE_DR)
...
#define SIZE_BUFFER_FOR_AR    ((10780 - 1700)*(NUMBER_ANALOG_CANALES + NUMBER_WORD_DIGITAL_PART_AR))
#elif (                                 \
...
#define SIZE_BUFFER_FOR_AR    ((10780 - 700)*(NUMBER_ANALOG_CANALES + NUMBER_WORD_DIGITAL_PART_AR))
#else
#define SIZE_BUFFER_FOR_AR    ((10780-300)*(NUMBER_ANALOG_CANALES + NUMBER_WORD_DIGITAL_PART_AR))
#endif
