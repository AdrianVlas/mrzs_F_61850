...
5(с - макс. доавар. мас.)х50(пром.частота)х16(кільк. вибор.за пер. для ан.р.)х(8(канали) + 15(двобайтні слова дискретних сигналів)) +1307*[512(байт)/2(байт на одне миттєве значення)](кількість миттєвих значень на сторінці)=
