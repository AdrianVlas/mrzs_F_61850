...
void umin1_handler(unsigned int *p_active_functions, unsigned int number_group_stp)
{
  ...
  //М
  unsigned int tmp_value = (((current_settings_prt.control_extra_settings_1 & CTR_EXTRA_SETTINGS_1_CTRL_PHASE_LINE) == 0) && ((current_settings_prt.control_transformator & CTR_TRANSFORMATOR_LINE_PHASE) != 0)) << 0;
...
inline void start_monitoring_min_U(unsigned int time_tmp)
{
  ...
  if (((current_settings_prt.control_extra_settings_1 & CTR_EXTRA_SETTINGS_1_CTRL_PHASE_LINE) == 0) && ((current_settings_prt.control_transformator & CTR_TRANSFORMATOR_LINE_PHASE) != 0))
  {
...
inline void continue_monitoring_min_U(unsigned int time_tmp)
{
  ...
  if (
      (
       (((current_settings_prt.control_extra_settings_1 & CTR_EXTRA_SETTINGS_1_CTRL_PHASE_LINE) == 0) && ((current_settings_prt.control_transformator & CTR_TRANSFORMATOR_LINE_PHASE) != 0)) &&
       (  
