...
int recordNumberCase0Case1(int offsetRegister, int recordNumber, int recordLen);
...
//Конфигурация аналогового регистратора
  ...
  switch(recordNumber)
    ...
    case 1://Количество каналов recordNumber
      return recordNumberCase0Case1(offsetRegister, recordNumber, recordLen);
    }//switch
...
//      return 3;
    ...
    /*
      case 4://день (Дата и время запуска) subObj
      {
        ...
        switch(offsetRegister)
        {
        case 0://день (Дата и время запуска) offsetRegister
          return 3;
        case 1://месяц offsetRegister
          return 3;
        case 2://год offsetRegister
