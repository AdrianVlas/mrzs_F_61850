...
enum ONM_EKRAN_LIST
{
  ...
  ONM_EKRAN_DATA_LADEL_DR                            = EKRAN_DATA_LADEL_DR                ,
  ...
  ONM_EKRAN_TITLES_PR_ERR_REGISTRATOR                = EKRAN_TITLES_PR_ERR_REGISTRATOR    ,
  ONM_EKRAN_DATA_LADEL_PR_ERR                        = EKRAN_DATA_LADEL_PR_ERR            ,
