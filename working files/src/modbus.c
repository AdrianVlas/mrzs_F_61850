...
inline unsigned int Get_data(unsigned char *data, unsigned int address_data, unsigned int type_interface, __getting_data target_task)
{
  ...
  else if ((address_data >= M_ADDRESS_FIRST_SETPOINTS_PART1) && (address_data <= M_ADDRESS_LAST_SETPOINTS_PART1))
  {
    ...
    case MA_TYPE_MTZ04_2:
      {
        unsigned int temp_input_data = target_label->type_mtz04_2;
          ...
          )
  {
    ...
    case MA_STP_MTZ04_1:
      {
        temp_value = target_label->setpoint_mtz04_1[num_gr]/10;
        break;
      }
    case MA_TO_MTZ04_1:
      {
        temp_value = target_label->timeout_mtz04_1[num_gr]/10;
        break;
      }
    case MA_STP_MTZ04_2:
      {
        temp_value = target_label->setpoint_mtz04_2[num_gr]/10;
        break;
      }
    case MA_TO_MTZ04_2:
      {
        temp_value = target_label->timeout_mtz04_2[num_gr]/10;
        break;
      }
    case MA_TO_MTZ04_2_VVID_PR:
      {
        temp_value = target_label->timeout_mtz04_2_vvid_pr[num_gr]/10;
        break;
      }
    case MA_TO_MTZ04_2_PR:
      {
        temp_value = target_label->timeout_mtz04_2_pr[num_gr]/10;
        break;
      }
    case MA_STP_NZZ1_3I0:
      {
        temp_value = target_label->setpoint_zz_3I0[num_gr];
        break;
      }
    case MA_TO_NZZ1_3I0:
      {
        temp_value = target_label->timeout_zz_3I0[num_gr]/10;
        break;
      }
    case MA_STP_NZZ1_3U0:
      {
        temp_value = target_label->setpoint_zz_3U0[num_gr]/10;
        break;
      }
    case MA_TO_NZZ1_3U0:
      {
        temp_value = target_label->timeout_zz_3U0[num_gr]/10;
        break;
      }
    case MA_TO_NZZ1:
      {
        temp_value = target_label->timeout_nzz[num_gr]/10;
        break;
      }
    case MA_STP_TZNP1_3I0_VPERED:
      {
        temp_value = target_label->setpoint_tznp_1_3I0_vpered[num_gr]/10;
        break;
      }
    case MA_STP_TZNP1_3U0_VPERED:
      {
        temp_value = target_label->setpoint_tznp_1_3U0_vpered[num_gr]/10;
        break;
      }
    case MA_TO_TZNP1_VPERED:
      {
        temp_value = target_label->timeout_tznp_1_vpered[num_gr]/10;
        break;
      }
    case MA_STP_TZNP1_3I0_NAZAD:
      {
        temp_value = target_label->setpoint_tznp_1_3I0_nazad[num_gr]/10;
        break;
      }
    case MA_STP_TZNP1_3U0_NAZAD:
      {
        temp_value = target_label->setpoint_tznp_1_3U0_nazad[num_gr]/10;
        break;
      }
    case MA_TO_TZNP1_NAZAD:
      {
        temp_value = target_label->timeout_tznp_1_nazad[num_gr]/10;
        break;
      }
    case MA_STP_TZNP1_ANGLE:
      {
        temp_value = target_label->setpoint_tznp_1_angle[num_gr];
        break;
      }
    case MA_STP_TZNP2_3I0_VPERED:
      {
        temp_value = target_label->setpoint_tznp_2_3I0_vpered[num_gr]/10;
        break;
      }
    case MA_STP_TZNP2_3U0_VPERED:
      {
        temp_value = target_label->setpoint_tznp_2_3U0_vpered[num_gr]/10;
        break;
      }
    case MA_TO_TZNP2_VPERED:
      {
        temp_value = target_label->timeout_tznp_2_vpered[num_gr]/10;
        break;
      }
    case MA_STP_TZNP2_3I0_NAZAD:
      {
        temp_value = target_label->setpoint_tznp_2_3I0_nazad[num_gr]/10;
        break;
      }
    case MA_STP_TZNP2_3U0_NAZAD:
      {
        temp_value = target_label->setpoint_tznp_2_3U0_nazad[num_gr]/10;
        break;
      }
    case MA_TO_TZNP2_NAZAD:
      {
        temp_value = target_label->timeout_tznp_2_nazad[num_gr]/10;
        break;
      }
    case MA_STP_TZNP2_ANGLE:
      {
        temp_value = target_label->setpoint_tznp_2_angle[num_gr];
        break;
      }
    case MA_STP_TZNP3_3I0_VPERED:
      {
        temp_value = target_label->setpoint_tznp_3_3I0_vpered[num_gr]/10;
        break;
      }
    case MA_STP_TZNP3_3U0_VPERED:
      {
        temp_value = target_label->setpoint_tznp_3_3U0_vpered[num_gr]/10;
        break;
      }
    case MA_TO_TZNP3_VPERED:
      {
        temp_value = target_label->timeout_tznp_3_vpered[num_gr]/10;
        break;
      }
    case MA_STP_TZNP3_3I0_NAZAD:
      {
        temp_value = target_label->setpoint_tznp_3_3I0_nazad[num_gr]/10;
        break;
      }
    case MA_STP_TZNP3_3U0_NAZAD:
      {
        temp_value = target_label->setpoint_tznp_3_3U0_nazad[num_gr]/10;
        break;
      }
    case MA_TO_TZNP3_NAZAD:
      {
        temp_value = target_label->timeout_tznp_3_nazad[num_gr]/10;
        break;
      }
    case MA_STP_TZNP3_ANGLE:
      {
        temp_value = target_label->setpoint_tznp_3_angle[num_gr];
        break;
      }
    case MA_STP_ZOP1:
      {
    ...
    case MA_STP_ACHR1_F_RAB:
      {
        temp_value = target_label->setpoint_achr1_f_rab[num_gr]/10;
        break;
      }
    case MA_STP_ACHR2_F_RAB:
      {
        temp_value = target_label->setpoint_achr2_f_rab[num_gr]/10;
        break;
      }
    case MA_STP_CHAPV1_F_RAB:
      {
        temp_value = target_label->setpoint_chapv1_f_rab[num_gr]/10;
        break;
      }
    case MA_STP_CHAPV2_F_RAB:
      {
        temp_value = target_label->setpoint_chapv2_f_rab[num_gr]/10;
        break;
      }
    case MA_STP_ACHR_CHAPV_UF:
      {
        temp_value = target_label->setpoint_achr_chapv_uf[num_gr]/100;
        break;
      }
    case MA_TO_ACHR_1:
      {
        temp_value = target_label->timeout_achr_1[num_gr]/10;
        break;
      }
    case MA_TO_ACHR_2:
      {
        temp_value = target_label->timeout_achr_2[num_gr]/10;
        break;
      }
    case MA_TO_CHAPV_1:
      {
        temp_value = target_label->timeout_chapv_1[num_gr]/10;
        break;
      }
    case MA_TO_CHAPV_2:
      {
        temp_value = target_label->timeout_chapv_2[num_gr]/10;
        break;
      }
    default:
      {
  ...
  else if ((address_data >= M_ADDRESS_FIRST_SETPOINTS_CONTINUE) && (address_data <= M_ADDRESS_LAST_SETPOINTS_CONTINUE))
  {
    ...
    case MA_OPIR_2_8:
      {
        ...
        if (shift_address == 0) temp_value = target_label->lines[line];
        else
        {
          shift_address--;
          ...
          {
            //Довжина лінії
            temp_value = target_label->dovgyna[line][shift_address >> 1];
          }
          else
          {
            //Опір лінії
            temp_value = target_label->opir[line][shift_address >> 1];
          }
        }
    ...
    case MA_T0:
      {
        temp_value = target_label->T0;
        break;
      }
    case MA_TT04:
      {
        temp_value = target_label->TCurrent04;
        break;
      }
    case MA_TO_SWCH_ON:
      {
    ...
    case MA_CONTROL_MTZ04:
      {
        int input_value = target_label->control_mtz04;
    ...
    case MA_CONTROL_NZZ:
      {
        int input_value = target_label->control_zz;
    ...
    case MA_CONTROL_TZNP:
      {
        int input_value = target_label->control_tznp;
    ...
    case MA_CONTROL_558:
      {
        int input_value1 = target_label->control_extra_settings_1;
    ...
    case MA_CONTROL_ACHR_CHAPV:
      {
        int input_value = target_label->control_achr_chapv;
    ...
    case MA_CONTROL_VMP:
      {
        int input_value = target_label->control_vmp;
    ...
    case MA_CONFIGURATION_PART1:
      {
        int input_value = target_label->configuration;
      ...
      case 1:
        {
          ...
          */
          ...
          case (252 + NUMBER_ANALOG_CANALES):
          ...
          if (number_record < (*(point_to_buffer + FIRST_INDEX_NUMBER_ITEMS_DR)))
          {
            ...
            if (length <= (3 + max_number_two_bytes))
            {
              ...
              while (i < length)
              {
                ...
                {
                  unsigned int offset = FIRST_INDEX_FIRST_DATA_DR + (number_record + 1)*38; //бо найперший запис містить попереднє значення (до фіксації запуску роботи дискретного реєстратора)
                  if (i == 1)
                  {
